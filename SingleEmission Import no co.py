...
#leave CO out of this list
linespecieslist = ['H2O','CH4','CO2','HCN','C2H2','NH3','SO2']
linefractionlist = [H2Ofraction,CH4fraction,CO2fraction,HCNfraction,C2H2fraction,NH3fraction,SO2fraction]
...
# Create the radtrans object (using linespecieslist, which doesnt contain CO)
...
# Simulate the emission spectrum
...
def plot(temperatures,pressures_bar,wavelengths,flux,other_outputs):
    ...
    axes[0,0].plot(temperatures, pressures_bar,label='Temperature')
...
#apply sphere sizes
Fs = CGSFs * 4 * np.pi * Rstar.to(u.cm)**2
...
axes[0,0].set_title("Planet emission")
...
axes[0,1].set_title("Stellar Emission")
...
axes[1,1].set_title("P-T Profile")
...
np.savetxt("/home/michel/code/data/v1298taub_FpFs_photochem1_noco.txt",output_data,delimiter=' ')
