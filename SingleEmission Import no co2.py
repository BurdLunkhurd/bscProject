...
linespecieslist = ['H2O','CO','CH4','HCN','C2H2','NH3','SO2']
linefractionlist = [H2Ofraction,COfraction,CH4fraction,HCNfraction,C2H2fraction,NH3fraction,SO2fraction]
...
np.savetxt("/home/michel/code/data/v1298taub_FpFs_photochem1_noco2.txt",output_data,delimiter=' ')
